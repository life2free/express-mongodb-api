...
/**
 * @api {get} /newss/search/keywords  Search news by conditions
 ...
 *   will get the list of news which match all of the conditions. The base url of api on heroku: https://express-news-api.herokuapp.com/v1
 * @apiName QueryNews
 * @apiGroup News
 * @apiVersion 1.0.0
 *
 * @apiParam {String} q(Optional). Keywords or phrases to search for in the title, author, description, content or the source name.
 *   the api will conduct fuzzyquery and ignore case with keywords or phrases.
 *   i.e: the keywords is: ?q=cather , then all of the news which one of the properties
 *   (title, author, description, content or the source name) includes "cather" match the conditions,
 *   and ignorecase the keywords or phrases.
 * @apiParam {String} _id(Optional). The news unique ID, which is a 24-bit hash string.
 * @apiParam {String} source._id(Optional). The source unique ID, refer to the Source collection, which is a 24-bit hash string.
 * @apiParam {String} date(Optional). The published date of the news, format: YYYY-MM-DD.
 * @apiParamExample {json} Request-Example:
 *  /newss/search/keywords?q=cather&date=2020-04-01
 *
 * @apiSuccess {String} _id  The news unique ID, which is a 24-bit hash string.
 * @apiSuccess {String} source._id  The source unique ID, refer to the Source collection.
 * @apiSuccess {String} source.name  The name of news source.
...
/**
 * @api {get} /sources/search/keywords  Search source by conditions
 ...
 *   will get the list of source which match all of the conditions.
 *   The base url of api on heroku: https://express-news-api.herokuapp.com/v1
 * @apiName QuerySource
 * @apiGroup Source
 * @apiVersion 1.0.0
 *
 * @apiParam {String} q(Optional). Keywords or phrases to search for in the name or description of source.
 *   the api will conduct fuzzyquery and ignore case with keywords or phrases.
 *   i.e: the keywords is: ?q=blast , then all of the source which one of the name or description
 *   includes "blast" match the conditions, and ignorecase the keywords or phrases.
 * @apiParam {String} _id(Optional). The news unique ID, which is a 24-bit hash string.
 ...
 * @apiParamExample {json} Request-Example:
 *  /sources/search/keywords?q=blast&country=br
 *
 * @apiSuccess {String} _id  The source unique ID, which is a 24-bit hash string.
 * @apiSuccess {String} id  The id of the source.
 * @apiSuccess {String} name  The name of the source.
