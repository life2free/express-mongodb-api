 ...
 * @apiDescription Get all of news
 * @apiName GetAllNews
 * @apiGroup News
 * @apiVersion 1.0.0
 *
 ...
 * @apiDescription Get the news by news unique ID
 * @apiName GetNewsById
 * @apiGroup News
 * @apiVersion 1.0.0
 *
 ...
 *   and its title includes "finan" match the conditions, and ignorecase the these parameters value.
 * @apiName QueryNews
 * @apiGroup News
 * @apiVersion 1.0.0
 *
 ...
 * @apiDescription Add a news to database
 * @apiName AddNews
 * @apiGroup News
 * @apiVersion 1.0.0
 *
 ...
 *  the properties of news which will be edit are in the request body.
 ...
 * @apiDescription Delete the news by news unique ID
 ...
 * @apiDescription Get all of source
 ...
 * @apiDescription Get the source by source unique ID
 ...
 * @apiDescription Add a source to database
 * @apiName AddSource
 * @apiGroup Source
 * @apiVersion 1.0.0
 *
 ...
 *  the properties of source which will be edit are in the request body.
 ...
 * @apiDescription Delete the source by news unique ID
